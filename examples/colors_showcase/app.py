...
from refast.components.shadcn.layout import Grid, Column, Row, Flex
...
def render_color_swatch(color_name: str, shade: int, bg_class: str, text_class: str) -> Flex:
    ...
    return Flex(
        class_name=f"{bg_class} rounded-md h-24 w-full p-2 flex flex-col justify-end items-start border border-border/20",
        children=[
            Paragraph(
                text=str(shade),
                class_name=f"{text_class} text-xs font-mono font-bold"
            ),
        ]
    )
...
def render_palette_row(color_name: str, base_color: str) -> Column:
    ...
    return Column(
        class_name="mb-6",
        children=[
            Heading(text=color_name, level=4, class_name="mb-2 text-sm font-semibold capitalize text-muted-foreground"),
            Grid(
                columns=11,
                gap=2,
                class_name="w-full",
        ...
        children=[
            ...
            Row([
                Column(
                    class_name="",
                    children=[
                        Heading(text="Refast Color Palette Showcase", level=1, class_name="text-4xl font-bold tracking-tight"),
                        Paragraph(
                    ...
                    CardContent(
                        ...
                        children=[
                            ...
                            Column(
                                gap=2,
                                children=[
                                    Paragraph(text="Buttons with semantic colors", class_name="text-sm font-medium text-muted-foreground"),
                                    Flex(
                                        gap=4,
                                        wrap="wrap",
                                        children=[
                            ...
                            Column(
                                gap=2,
                                children=[
                                    Paragraph(text="Badges", class_name="text-sm font-medium text-muted-foreground"),
                                    Flex(
                                        gap=2,
                                        children=[
