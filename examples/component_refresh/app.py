        ...
        children=[
            ...
            Container(
                ...
                children=[
                    ...
                    Text(f"Global App State (Shared): Full={state.counter_full}, Partial={state.counter_partial}"),
                    ...
                    Card(
                        ...
                        children=[
                            Container(
                                ...
                                children=[
                                    Text("Clicking below refreshes the ENTIRE page.", class_name="text-sm font-semibold"),
                                    
                                    Row(
                                        class_name="bg-red-50 p-4 rounded border border-red-200",
                                        children=[
                                            Text(f"Counter: {state.counter_full}", class_name="text-xl font-bold text-red-700"),
                                            Text(f"Random Val: {state.random_val}", class_name="text-sm text-red-600"),
                                            Text(f"Update Timestamp: {asyncio.get_event_loop().time()}", class_name="text-xs text-green-800 mt-2"),
                                        ],
                                        gap=4,
                                        align="center",
                                    ),
                    ...
                    Card(
                        ...
                        children=[
                            Container(
                                class_name="space-y-4 p-4",
                                children=[
                                    Text("Clicking below refreshes ONLY this card.", class_name="text-sm font-semibold"),
                                    ...
                                    Row(
                                        ...
                                        children=[
                                            Text(f"Counter: {state.counter_partial}", class_name="text-xl font-bold text-green-700"),
                                            Text(f"Random Val: {state.random_val}", class_name="text-sm text-green-600"),
                                            Text(f"Update Timestamp: {asyncio.get_event_loop().time() if state.counter_partial > 0 else 'Never'}", class_name="text-xs text-green-800 mt-2"),
                                        ],
                                        gap=4,
                                        align="center",
                                    ),
