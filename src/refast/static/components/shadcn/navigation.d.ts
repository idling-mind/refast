...
export declare function CommandItem({ id, className, icon, value, disabled, onSelect, children, 'data-refast-id': dataRefastId, }: CommandItemProps): React.ReactElement;
